    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length <= 0)
            {
                ...
                Console.WriteLine(
                    "Please enter a command as the first argument.  Try 'B2CGraphShell Help' for a list of commands.");
        ...
        private static void UpdateUser(string[] args)
        {
            if (args.Length <= 2)
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine(
                    "Please include an objectId and a path to a .json file.  Run B2CGraphShell Syntax to see examples.");
                Console.ForegroundColor = init;
                return;
            }
        ...
        private static void GetExtensionAttribute(string[] args)
        {
            if (args.Length <= 1)
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine(
                    "Please include the b2c-extensions-app objectId.  Run B2CGraphShell Syntax to see examples.");
                Console.ForegroundColor = init;
                return;
            }
        ...
        private static void GetB2CExtensionApplication(string[] args)
        {
            object formatted =
                JsonConvert.DeserializeObject(
                    client.GetApplications("$filter=displayName eq 'b2c-extensions-app'").Result);
            Console.ForegroundColor = ConsoleColor.White;
            Console.WriteLine(JsonConvert.SerializeObject(formatted, Formatting.Indented));
        }
        ...
        private static void PrintSyntax(string[] args)
        {
            ...
            Console.WriteLine(
                "                             : B2C Get-Extension-Attribute 909544d8-f8c0-49c7-b137-a89faff6f882");
